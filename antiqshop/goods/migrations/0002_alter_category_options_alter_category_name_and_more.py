# Generated by Django 4.2.1 on 2024-03-04 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Скидка в %')),
                ('quantity', models.PositiveIntegerField(default=0, verbose_name='Количество')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='goods.category', verbose_name='Категория')),
            ],
            options={
